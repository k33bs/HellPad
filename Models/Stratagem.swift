...
struct UserData: Codable {
    ...
    var stratagemCompanionEnabled: Bool?
    var stratagemCompanionDebugWindowEnabled: Bool?
    var reloadMonitorEnabled: Bool?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case stratagemCompanionEnabled = "stratagem_companion_enabled"
        case stratagemCompanionDebugWindowEnabled = "stratagem_companion_debug_window_enabled"
        case reloadMonitorEnabled = "reload_monitor_enabled"
