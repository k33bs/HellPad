...
- **Bug Fix** - Removed the stale yellow focus-ring that appeared around the first stratagem slot when the HellPad window gained focus.
...
- **Voice Feedback on Loadout Switch** - Hear loadout names spoken when switching
  ...
  - Configurable voice selection (System Default or any installed voice)
